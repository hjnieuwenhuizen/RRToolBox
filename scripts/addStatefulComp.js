...
const run = async() => {
    ...
    await findReplace(compNameFormatted + 'Container.js', /ComponentName/g, compNameFormatted + 'Component');
    await findReplace(compNameFormatted + 'Container.js', /ContainerName/g, compNameFormatted + 'Container');
    await findReplace('index.js', /ContainerName/g, compNameFormatted + 'Container');
